...
<!-- Mirrored from preview.keenthemes.com/craft/authentication/sign-in/password-reset.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Dec 2023 05:43:09 GMT -->
...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/craft/authentication/sign-in/new-password.html" id="kt_password_reset_form">
    <!--begin::Heading-->
    ...
    <div class="d-flex flex-wrap justify-content-center pb-lg-0">
        ...
        <a href="/admin" class="btn btn-lg btn-light-primary fw-bold">Cancel</a>
    </div>
    <!--end::Actions-->
</form>
<!--end::Form-->
