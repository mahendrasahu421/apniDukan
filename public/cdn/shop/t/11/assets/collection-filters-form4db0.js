...
Line 47:10 Transforming rest arguments to the configured target environment ("es5") is not supported yet
Line 53:0 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 54:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
function renderProductSortView () {
  if ( typeof $.cookie('productSortView') == 'undefined' ) {
    ...
    $('#product_listing__sorted').addClass('product_listing__list').removeClass('product_listing__grid product_listing__grid_large product_listing__grid_small');
  } else if ( $.cookie('productSortView') == 'grid' ){
    $('#view_list, #view_grid_large, #view_grid_small').removeClass('active');
    $('#view_grid').addClass('active');
    $('#product_listing__sorted').addClass('product_listing__grid').removeClass('product_listing__list product_listing__grid_large product_listing__grid_small');
    ...
    $('#product_listing__sorted').addClass('product_listing__grid_large').removeClass('product_listing__list product_listing__grid product_listing__grid_small');
    ...
    $('#product_listing__sorted').addClass('product_listing__grid_small').removeClass('product_listing__list product_listing__grid product_listing__grid product_listing__grid_large');
  }
}
